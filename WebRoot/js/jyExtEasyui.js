...
jy.modalDialog = function(options) {
	...
	if (options.url) {
		...
		url = encodeURI(encodeURI(options.url));
		opts.content = '<iframe id="'+optid+'" src="' + url + '" allowTransparency="true" scrolling="auto" width="100%" height="98%" frameBorder="0" name=""></iframe>';
	}
