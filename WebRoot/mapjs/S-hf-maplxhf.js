...
initMap();
var carico = new BMap.Icon("./images/kc.png", new BMap.Size(33,25), {imageOffset: new BMap.Size(0, 0) });
...
function play(){
	...
	if (i < paths) {
		...
		geoc.getLocation(pts[i], function(rs){
			var addComp = rs.addressComponents;
			address=addComp.province + ", " + addComp.city + ", " + addComp.district + ", " + addComp.street + ", " + addComp.streetNumber;
			var lbtext="用户名："+CARNO+"<br>当前经纬度："+pts[i].lng+","+pts[i].lat+"<br>当前位置："+address;
			label = new BMap.Label(lbtext, {
