  ...
  <script type="text/javascript">
  		...
  		/* 	remoteSort:true, */
  			...
  			{field : 'shipping_order_state',title : '订单状态',width : 70,align:'center',
				...
				,editor:{
  				...
  				{field : 'ys_unloading_fee',title : '应收落地费',width : 80,align:'center',sortable:'true'
  				,editor:{
	                	type:'text',
	          			     options:{
	                			
	                    	validType:'ys_unloading_fee'
	                	}}},
	...
	btnMoreSearch.click(function() {
 	...
 	function add() {
		dialog = parent.jy.modalDialog({
			title : '添加位置区域',
			url : 'addplace.do?method=addShipOrder&pid='+pid,
			width : 680,
			buttons : [{
