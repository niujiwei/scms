...
<body class="easyui-layout">
	...
	<div class="easyui-layout" data-options="region:'center'">
		<div region="north" title="检索" class="st-north" border="false"
			...
			<label>用户名：</label><input id="user_name" type="text"
				class="search-text"> <label class="divlabel">真实姓名：</label><input
				id="user_realName" type="text" class="search-text"> <input
				type='hidden' id="did" name='did'> <a
				class="easyui-linkbutton" onclick="searchUser()"
				data-options="iconCls:'icon-search'" id="searchId">查询</a>
		</div>
		<div region="center" title="用户信息展示"
