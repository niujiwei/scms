		...
		<fieldset>
			<table class="tableclass">
				...
				<tr>
					...
					<td >应收落地费：</td>
					<td class="td2"><input id="send_pay" type="text"   readonly="true"  class="validate[custom[number],max[99999.99],min[0.00],custom[dd]]" placeholder="0.00" value="0.00" name="ys_unloading_fee" /></td>
				</tr>
				<tr>
					<td >应收其他费：</td>
				...
				<tr>
					<td >应收备注:</td>
					<td colspan="3" class="td2">
					<textarea class="easyui-textarea" cols="45" rows="2"  readonly="true"  name="remarks_fee"></textarea></td>
				</tr> 
				 <tr>
				 <td >代收货款：</td>
