			...
			<table class="tableclass">
				...
				<tr>
					...
					<td class="td2"><input type="text" id="num"
						name="shiping_order_num" readonly="readonly">
					</td>

					<td>订单状态:</td>
					<td class="td2"><input type="text" id=""
						name="shipping_order_statestr" readonly="readonly">
					</td>
				</tr>
				<tr>
                   ...
                   <td>出货订单号:</td>
					<td class="td2"><input type="text" id="shiping_order_goid"
						name="shiping_order_goid" readonly="readonly">
					</td>
					<td>受理机构:</td>
					<td class="td2"><input type="text" id="" name="send_mechanism"
						readonly="readonly">
					</td>
				<tr>
					<td>起运时间：</td>
					...
					<td class="td2"><input type="text" id="end_address"
						name="end_address" readonly="readonly">
					</td>
				</tr>

				<tr>
					<td>收货客户地址：</td>
					<td class="td2"><input type="text" id="" name="end_mechanism"
						readonly="readonly">
					</td>
					<td>客户编号：</td>
				...
				<tr>
					...
					<td class="td2"><input type="text" id="custom_name"
						name="custom_name" readonly="readonly"></td>
					<td>发货客户联系人：</td>
					<td class="td2"><input type="text" id="custom_contact"
						name="custom_contact" readonly="readonly">
					</td>
				</tr>
				<tr>
					<td>发货客户电话：</td>
					<td class="td2"><input type="text" id="custom_tel"
						name="custom_tel" readonly="readonly">
					</td>
					<td>收货客户名称：</td>
					<td class="td2"><input type="text" id="receipt" name="receipt"
						readonly="readonly">
					</td>
				</tr>
				<tr>
					...
					<td class="td2"><input type="text" id="receipt_name"
						name="receipt_name" readonly="readonly">
					</td>

					<td>收货客户电话：</td>
					<td class="td2"><input type="text" id="receipt_tel"
						name="receipt_tel" readonly="readonly">
					</td>
				</tr>
				...
				<tr>
					<td>总重量(千克)：</td>
					<td class="td2"><input type="text" readonly="readonly"
						type="text" placeholder="0.0000" name="goods_weight" />
					</td>

					<td>总体积(立方米)：</td>
					<td class="td2"><input type="text" readonly="readonly"
						type="text" placeholder="0.0000" name="goods_vol" />
					</td>
				...
				<tr>
					...
					<td colspan="3" class="td2"><textarea class="easyui-textarea"
							cols="45" rows="2" name="remarks"></textarea> <input
						type="hidden" name="creat_type" value="0" style="width:150px">
						<input type="hidden" id="user" editable="" name="shipping_order" />
						<input type="hidden" id="cid" editable="" name="custom_id" /></td>
				</tr>
			...
			<table class="tableclass" style="display: none;" id="signtable">
				<tr>
					...
					<td class="td2"><input class="" type="text"
						name="sign_user" id="sign_user" class="validate[required]"/></td>
				...
				<tr>
					<td style="color: blue;"><span style="color: red"></span><font color="red" style="margin-right:10px">*</font>实际数量：</td>
					<td class="td2"><input type="text" editable=""
						name="actual_number" id="actual_number" onblur="checksj(this)" class="validate[required]"/>
					</td>

					<td style="color: blue;"><span style="color: red"></span><font color="red" style="margin-right:10px">*</font>缺失数量：</td>
					<td class="td2"><input type="text" editable=""
						name="defect_number" id="defect_number" onblur="checkqs(this)" class="validate[required]" />
					</td>
				</tr>
				<tr>
					<td style="color: blue;"><span style="color: red"></span><font color="red" style="margin-right:10px">*</font>回单份数：</td>
					<td class="td2"><input type="text" editable=""
						name="copies_number" id="copies_number" onblur="checkhd(this)" class="validate[required]"/>
					</td>

					<td style="color: blue;"><span style="color: red"></span><font color="red" style="margin-right:10px">*</font>收货日期：</td>
					<td class="td2"><input
						onfocus="WdatePicker({isShowWeek:true})" id="sign_time"
						name="sign_time"  class="validate[required]"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="color: blue;">签收备注:</td>
					<td colspan="3" class="td2"><textarea class="easyui-textarea"
							cols="45" rows="2" name="sign_remarks"></textarea>
					</td>
				</tr>
				<tr id="trupload">
					<td>回单上传：</td>
