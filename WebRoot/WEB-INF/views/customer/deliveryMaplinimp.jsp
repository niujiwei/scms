...
var filename="<%=s%>";
		if (filename != null || filename != "") {
			...
			$.ajax({
				type : "POST",
				url : 'deliveryCustomer.do?method=implinplan',
				data : {
				    pid:pid,
					filename : filename,
					usersname : usersname
	...
	<div>
		<div style="text-align: center;  margin-top: 40px;">
			<div class="uploader white">
				<form action="deliveryCustomer.do?method=startimplinplan" id="impform"
		...
		<br>
		<div
			style="text-align: center;font-family: 'Microsoft YaHei', 微软雅黑, Arial, Helvetica, sans-serif; font-size: 13px;  color: blue;">提示：请选择正确的文件格式（.xlsx或者.xls
			）<br><!-- <span style="color:red">导入失败原因：请检查excel金额列是否有非数字数据</span> 
			<br>--></div>
	</div>
</body>
</html>
