...
<script type="text/javascript">
    ...
    $(function () {
        grid = $("#dg")
            .datagrid(
                {
                    url: 'driverAccount.do?method=getDriverAccountInfo',
                    border: false,
                    rownumbers: true,
                    fit: true,
                    singleSelect: false,
                    ...
                    onDblClickRow: function (rowIndex, rowData) {
                        var pid = rowData.driver_id;
                        var min_send_time = rowData.min_send_time;
                        var driverId = rowData.driver_id;
                        //var time=document.getElementById("timeId").value;
                        var max_send_time = rowData.max_send_time;
                        ...
                        dialog = parent.jy
                            .modalDialog({
                                title: '司机运单查看',
                                url: 'driverAccount.do?method=toDriverAccountOrder&pid='
                                + pid
                                + '&min_send_time='
                                + min_send_time
                                + '&max_send_time='
                   ...
                   /* rowStyler: function (index, row) {
                    ...
                    columns: [[
                        ...
                        {
                            field: 'driver_trade_agency',
                            title: '代收货款',
                            width: 100,
                            align: 'center'
                        },
                        {field : 'driver_goods_weight',title: '总重量',width:100,align:'center'},
                        {field : 'driver_goods_vol',title : '总体积',width : 100,align:'center'},
    ...
    function searchCar_owner() {
        ...
        $("#dg").datagrid('load', {
            ...
            startTime: timeId,//开始时间
            endTime: timeIdd,//结束时间
            driver_name: $.trim($("#driver_name").val()),
            driver_phone: $.trim($("#driver_phone").val()),//供应商名称
        });
    }
    //导出
    function putoutfile() {
...
<form action="driverAccount.do" id="outputform" method="post">
    <div region="north" title="检索" class="st-north" border="false"
        ...
        <input id="timeIdd" class="Wdate" readonly="readonly"
               ...
               onfocus="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd'})"/> <label>司机名称:</label>
        <input type="text" id=driver_name style="width: 150px;" name="driver_name"/>
        <label>手机号:</label>
        <input type="text" id="driver_phone" style="width: 150px;" name="driver_phone"/>
       <a
    ...
    <input type="hidden" name="method" value="outDriverAccountOrder"> <input
