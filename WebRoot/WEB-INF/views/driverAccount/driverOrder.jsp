...
<%
	...
	String min_send_time = (String) request.getAttribute("min_send_time");
	String max_send_time = (String) request.getAttribute("max_send_time");
...
<script type="text/javascript">
 		...
 		var editval;
 		var pid='<%=flg%>';
 		var min_send_time ='<%=min_send_time%>';
 		var max_send_time = '<%=max_send_time%>';
	...
	$(function() {
		grid = $("#dg").datagrid(
				{
					url : 'driverAccount.do?method=getDriverAccountOrder&pid=' + pid
							+ '&min_send_time=' + min_send_time + '&max_send_time=' + max_send_time
							+ '&driverId=' + driverId,
					border : false,
					rownumbers : true,
					fit : true,
