...
<body class="easyui-layout">
	<form action="agreement.do" id="outputform" method="post">
		<div region="north" title="检索" class="st-north" border="false"
			style="height:60px" collapsible="false">

			<lable>消息标题:</lable>
			<input class="search-text" id="message_title" style="width:150px">
			<lable>消息创建者:</lable>
			<input class="search-text" id="message_createuser"
				style="width:150px">
			<lable>消息日期:</lable>
			<input id="startDate" class="Wdate" readonly="readonly"
				style="width:150px;height:22px; margin: 5px 5px 5px 1px;"
				onfocus="WdatePicker({skin:'twoer', dateFmt:'yyyy-MM-dd'})" /> - <input
				id="endDate" class="Wdate" readonly="readonly"
				style="width:150px;height:22px;margin: 5px 5px 5px 1px;"
				onfocus="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd'})" /> <a
				class="easyui-linkbutton" onclick="searchAgreement()"
		...
		<div id="tb">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				data-options="iconCls:'icon-add',plain:true" onclick="addMessage()"
				id="tbadd" style="display: none;">添加消息</a> <a
				href="javascript:void(0)" class="easyui-linkbutton"
				data-options="iconCls:'icon-remove',plain:true"
				onclick="deleteMessage()" id="tbdel" style="display: none;">删除</a>

		</div>

		<input type="hidden" name="method" value="outAgreement"> <input
