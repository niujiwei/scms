            ...
            <div class="panel-bodys">
                <div class="form-horizontal">
                    ...
                    <div class="form-group" style="margin-top: 15px;">
                        ...
                        <div class="col-sm-4">
                            <label style="margin-top: 7px;"><%=user.getUsername()%>
                            </label>
                        </div>
                    ...
                    <div class="form-group" style="margin-top: 15px;">
                        <label for="" class="col-sm-2 control-label">姓名</label>
                        <div class="col-sm-4">
                            <label style="margin-top: 7px;"><%=user.getRealName()%>
                            </label>
                        </div>
                    ...
                    <div class="form-group" style="margin-top: 15px;">
                        ...
                        <div class="col-sm-4">
                            <div class="controls" style="margin-top:6px; ">
                                <a href="javascript:void(0)" class="input-file" onclick="btnheadfile()"
                                   style="margin-top: 7px;">上传</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="password" class="form-control" id="password1" name="password1"
                                       placeholder="请输入您的原始密码" style="width:250px;margin-top: 7px;background: #fff;">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="password" class="form-control" id="password2" name="password"
                                       placeholder="请输入您的新密码" style="width:250px;margin-top: 7px;background: #fff;">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="password" class="form-control" id="password3" name="password"
                                       placeholder="请再次输入您的新密码" style="width:250px;margin-top: 7px;background: #fff;">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="uploader white">
                        <input type="text" id="filename" class="filename"
                               readonly="readonly"/> <input type="button" name="file"
                                                            class="button" value="选择文件"/> <input type="file"
                                                                                                 name="imgFile"
                                                                                                 size="30"/>
                    </div>
                    <br>
