...
var filename="<%=s%>";
		if (filename != null || filename != "") {
			...
			$.ajax({
				type : "POST",
				url : 'orderC.do?method=implinplanexcle',
				data : {
					filename : filename,
					usersname : usersname
				},
				success : function(msg) {
					...
					var ms="<span>导入完成！<br>总数据为 ："+zs+"<br>导入成功数："+cg+"</span>"+"<br>未导入订单号："+order+"</span>";
...
<body style="overflow: hidden;">
	...
	<div>
		<div style="text-align: center;  margin-top: 40px;">
			...
			<form action="orderC.do?method=startimplinplanexcle" id="impform"
					method="post" enctype="multipart/form-data">
					<input type="text" id="filename" class="filename"
						readonly="readonly" /> <input type="button" name="file"
						class="button" value="选择文件" /> <input type="file" name="files" size="30" /><br>
