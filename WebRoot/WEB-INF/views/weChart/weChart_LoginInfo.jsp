...
<html>
	...
	<body>
		...
		<div class="mui-content">
			...
			<form action="weChart.do?method=weChartSaveUserInfo" method="post" id="weChartSaveForm">
				<div class="weui-cells">
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">
							<input class="weui-input" type="text" name="username" style="margin-bottom: 0px;" id="username" placeholder="请输入姓名">
						</div>
					</div>
					<div class="weui-cell">
						<div class="weui-cell__hd">
						...
						<div class="weui-cell__bd">
							<input class="weui-input" type="tel" id="phone" name="phone" placeholder="请输入手机号" style="margin-bottom: 0px;">
						</div>
					</div>
