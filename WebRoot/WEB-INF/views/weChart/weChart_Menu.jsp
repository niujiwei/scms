...
<html>
	...
	<body>
		...
		<div class="mui-content">
			<div class="weui-cells__title">用户微信信息</div>
			<div class="weui-cells">
				<div class="weui-cell">
					<div class="weui-cell__hd">头像</div>
					<div class="weui-cell__bd"></div>
					<div class="weui-cell__ft">
						<img src='WeChart/mui/images/orderimg.png' style="width:20px;margin-right:5px;display:block" id="headimgurl">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd">用户名称</div>
					<div class="weui-cell__bd"></div>
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd"></div>
					<div class="weui-cell__ft" id="province"></div>
				</div>
			</div>
			...
			<div class="weui-cells">
				<a class="weui-cell weui-cell_access" href="javascript:;" id="weChartOrder">
					<div class="weui-cell__bd">
						<p class="myOrder">我的运单</p>
					</div>
					<div class="weui-cell__ft">点击查看我的运单</div>
				</a>
			</div>
		</div>
		<div id="dialogs">
			...
			<div class="js_dialog" id="dlgUpdateUserName" style="display: none;">
				...
				<div class="weui-dialog weui-skin_android">
					<div class="weui-dialog__bd">修改姓名<input class="weui-input" type="text"  id="textUserName">
					</div>
					<div class="weui-dialog__ft">
						<a href="javascript:;" class="weui-dialog__btn weui-dialog__btn_default">取消</a>
						<a href="javascript:;" id="btnUpdateUserName" class="weui-dialog__btn weui-dialog__btn_primary">确认</a>
					</div>
				</div>
			</div>
			...
			<div class="js_dialog" id="dlgUpdateUserPhone" style="display: none;">
				<div class="weui-mask"></div>
				<div class="weui-dialog weui-skin_android">
					<div class="weui-dialog__bd">修改手机号<input class="weui-input" type="text"  id="textUserPhone">
					</div>
					<div class="weui-dialog__ft">
						<a href="javascript:;" class="weui-dialog__btn weui-dialog__btn_default">取消</a>
						<a href="javascript:;" id="btnUpdateUserPhone" class="weui-dialog__btn weui-dialog__btn_primary">确认</a>
					</div>
				</div>
			</div>
		...
		JSONObject jsonUser = JSONObject.fromObject(user);
           %>
			...
			function openOrder(openid) {
				var id = openid.val();
				mui.openWindow({
					url: 'weChart.do?method=weChartToOrder&openid=' + id,
					id: 'orderlist',
				});
			};

			function updateUserNamePhone(userName, phone) {
				mui.ajax('weChart.do?method=weChartUpdateUserInfo', {
					data: {
						openid: user.openid,
						username: userName,
						phone: phone,
