  ...
  <script type="text/javascript">
 		...
 		var grid;
  		$(function(){
  			...
  			multiSort:true,	 	
  			columns : [[ 				
				{field:'custom_name',title:'客户名称',width:80,align:'center',rowspan:2 },
			...
			/*  */
				...
				[
  				...
  				{field : 'car_rcar_remarks',title : '大车备注',width : 80,align:'center'},
...
tmp.location=owurl;
  ...
  <body class="easyui-layout">
	...
	<div region="north" title="检索" class="st-north" border="false" collapsible="false"  >
    	<lable>到&nbsp;站:</lable>
			<input type="text" class="search-text" id="endaddress" >
	    	<lable >订单编号:</lable>
	    	...
	    	<lable>收货人:</lable>
	    	 <input type="text" class="search-text" id="receipt"  style="width:150px"  >	    	 	    	
	    	  <lable >客户名称:</lable>
	    	 <input  type="hidden" class="search-text" id="custom_name"  style="width:150px"  >	    	  	 	    	 
			 <lable >订单状态:</lable>
