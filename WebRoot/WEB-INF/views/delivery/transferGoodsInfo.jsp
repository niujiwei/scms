...
<html>
  ...
  <script type="text/javascript">
 		...
 		var pid='<%=flg%>';
  		$(function(){
  			grid=$("#dg").datagrid({
  			url : 'delivery.do?method=gettransferGoods',
  			border : false,
  			rownumbers : true,
  			fit : true,
  			singleSelect : false,
  	...
  	<form action="delivery.do" id="outputform" method="post">
    	<div region="north" title="检索" class="st-north" border="false" collapsible="false"  >
    	 <lable>中转日期:</lable>
			...
			-
			<input id="end_date"  class="Wdate"  readonly="readonly" style="width:130px;height:22px;" onfocus="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
	 	
	    	<lable >订单编号:</lable>
	    	 <input type="text" class="search-text" id="num"  style="width:130px;margin-right:0px"  >
	    	 
	    	<lable >中转公司:</lable>
	    	 <input type="hidden" class="search-text" id="changecompany"  style="width:130px;margin-right:0px"  >    	 
	    	    <lable >收货人:</lable>
			...
			<lable>到&nbsp;站:</lable>
			<input type="text" class="search-text" id="endaddress"style="width:130px;margin-right:0px" >
			  <lable>车牌号:</lable>
