...
<html>
  ...
  <script type="text/javascript">
 		...
 		var pid='<%=flg%>';
  		$(function(){
  			grid=$("#dg").datagrid({
  			url : 'delivery.do?method=getSign',
  			border : false,
  			rownumbers : true,
  			fit : true,
  			singleSelect : false,
  ...
  <body class="easyui-layout">
  	<form action="delivery.do" id="outputform" method="post">
    	<div region="north" title="检索" class="st-north" border="false" collapsible="false"  >
    		 <lable>提货日期:</lable>
			<input  id="send_time"  class="Wdate"  readonly="readonly" style="width:150px;height:22px; " onfocus="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
			-
			<input id="end_date"  class="Wdate"  readonly="readonly" style="width:150px;height:22px;" onfocus="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
	    	<lable >订单编号:</lable>
	    	 <input type="text" class="search-text" id="num"  style="width:150px;margin-right:0px"  >   	
	    	 <lable >收货人:</lable>
	    	 <input type="text" class="search-text" id="receipt"  style="width:150px"  >	  	    	
	    	 ...
	    	 <lable >品名:</lable>
	    	 <input type="text" class="search-text" id="goods_name"  style="width:150px;margin-right:0px"  >     
	    	 <lable >件数:</lable>
	    	 <input type="text" class="search-text" id="goods_num"  style="width:150px;margin-right:0px"  >
	    	   <lable >付款方式:</lable>
	    	 ...
	    	 <lable >签收人:</lable>
	    	 <input type="text" class="search-text" id="signperson"  style="width:150px"  >     
  	    	  <lable >车牌号:</lable>
	    	 <input  type="hidden" class="search-text" id="carnum"  style="width:150px"  >
			</div>
    	</div>
    	<div region="center" >
