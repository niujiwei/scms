  		...
  		$(function(){
  			...
  			columns : [[ 				
				...
				{field : 'send_time',title : '发车日期',width : 120,align:'center'},
  				...
  				{field : 'create_time',title : '送货日期',width : 80,align:'center'},
  				...
  				{field : 'writeoff1',title : '核销状态',width : 80,align:'center',hidden:true},
  				{field : 'write_off1',title : '核销状态',width : 80,align:'center',
  				formatter:function(val,row,index){
  					if(val==3){
  							return "未付款";
  						}else if(val==0){
	...
	btnMoreSearch.click(function() {
  	...
  	*/
  	...
  	function searchCar_owner(){
  		...
  		var send_timet=document.getElementById("send_timet").value;
  		$("#dg").datagrid('load',{			
  				send_time :send_time,
	 	 		send_timet :send_timet,			 		
	 	 		num:$.trim($("#num").val()),//订单号	 	 	
	 	 		carnum:$.trim($("#carnum").select2("val")),  	//车牌号			
  				signperson  :$.trim($("#signperson  ").val()), //收货人
  				goods_num:$.trim($("#goods_num").val()),
  				goods_name:$.trim($("#goods_name").val()),
  				car_name:$.trim($("#car_name").val()),
  				receipt_address:$.trim($("#receipt_address").val()),
  ...
  <body class="easyui-layout">
  	<form action="delivery.do" id="outputform" method="post">
    	<div region="north" title="检索" class="st-north" border="false" collapsible="false"  >
    	 <lable>送货日期:</lable>
			<input  id="send_time"  class="Wdate"  readonly="readonly" style="width:130px;height:22px; " onfocus="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
			-
			<input id="send_timet"  class="Wdate"  readonly="readonly" style="width:130px;height:22px;" onfocus="WdatePicker({skin:'twoer',dateFmt:'yyyy-MM-dd HH:mm:ss'})" /> 	
	    	  <lable >送货车号:</lable>
	    	 <input  type="hidden" class="search-text" id="carnum"  style="width:130px"  >	
	    	 <lable >订单编号:</lable>
	    	 <input type="text" class="search-text" id="num"  style="width:130px;margin-right:0px"  >    
	    	<lable>收货人:</lable>
	    	 <input type="text" class="search-text" id="signperson"  style="width:130px"  >	    	
	    	 ...
	    	 <div id="searchInfoId" style="display: none">	
	   		...
	   		<!-- <lable >收货人电话:</lable>
	    	 <input type="text" class="search-text" id="signphone"  style="width:150px"  >	  -->
	    	 <lable >件数:</lable>
	    	 <input type="text" class="search-text" id="goods_num"  style="width:130px;margin-right:0px"  >    	 
	    	 <lable >品名:</lable>
	    	 <input type="text" class="search-text" id="goods_name"  style="width:130px;margin-right:0px"  >    
	    		 	    	 
			
	    	 <lable>送货司机:</lable>
	    	 <input type="text" class="search-text" id="car_name"  style="width:130px;margin-right:0px"  >	    	 	    	
	    	  
	    	 <lable>送货地址:</lable>
			<input type="text" class="search-text" id="receipt_address" style="width:130px;margin-right:0px" > 	 
			<lable >订单状态:</lable>
    	...
    	<div region="center" >
    		<table id="dg" title="送货信息" ></table>
    	</div>
    	<input type="hidden" name="method" value="outDeliverGoods">
