...
var filename="<%=s%>";
		if (filename != null || filename != "") {
			...
			$.ajax({
				type : "POST",
				url : 'driver.do?method=implinplan',
				data : {
					pid : pid,
					filename : filename,
					usersname : usersname
				...
				success : function(msg) {
					...
					var cg = msg.split("#")[1];
					var ms;
					if (msg.split("#")[2] != null && msg.split("#")[2] != "") {
						ms = "<span>导入完成！<br>总数据为 ：" + zs + "<br>导入成功数：" + cg
								+ "<br>未导入订单：" + msg.split("#")[2];
						+"</span>";
					} else {
						ms = "<span>导入完成！<br>总数据为 ：" + zs + "<br>导入成功数：" + cg
								+ "</span>";
	...
	<div>
		<div style="text-align: center;  margin-top: 40px;">
			<div class="uploader white">
				<form action="driver.do?method=startimplinplan" id="impform"
