	...
	<input type="hidden"   name="change_fee1" >
 	<table class="tableclass">
			<tr>
					...
					<input type="radio" name="write_off" value="1"  style="width:14px"/><label style="margin-left: 10px">现金</label>
					<input type="radio"  name="write_off" value="0"  style="width:14px" /><label  style="margin-left: 10px">刷卡</label>
					</td> 
					</tr>
					<tr>
