...
public class MarginOrderController {
	...
	public String getSearchShipMargin() {
		return "margin/orderCustomMargin";
	}
	@RequestMapping(params = "method=getSourceShip")
	public @ResponseBody
	Map getSourceShip(String rows, String page, 
			String name ,String start_date1,String end_date2,String start_date,String end_date,String car_number,String type,String send_address,String phone) {
		...
		List<OrderCustom> list = mos.getMarginOrder((page1 - 1) * rows1,rows1, name, start_date1, end_date2, start_date, end_date, car_number, type, send_address, phone);
		int count = mos.getMarginOrderCount(name, start_date1, end_date2, start_date, end_date, car_number, type, send_address, phone);
	...
	public @ResponseBody
	List<OrderCustom> outSourceShip(HttpServletResponse response,String[] headtitle, String[] fieldName) {
		String filename = "单车毛利信息导出";
		List<OrderCustom> list=mos.getMarginOrder(null,null,null,null,null,null,null,null,null,null,null);
		...
		try {
			...
			// 调用工具类创建表头
			ExportUtils.outputHeaders(headtitle, workbook, "单车毛利信息导出");
			// 调用工具类生成内容
			ExportUtils.outputColums(fieldName, list, workbook, 1, "单车毛利信息导出");
	...
	public @ResponseBody 
	List<ShippingOrder> outShipOrder(HttpServletResponse response,String[] headtitle,String[] fieldName) {
		String filename = "单票毛利信息导出";
		List<ShippingOrder> list=mos.getMarginShip(null,null,null,null,null,null,null,null,null,null,null,null);
