...
public class CityController {
	...
	Map getCityInfo(String rows, String page, String cityname, String cityzm) {
		...
		List<City_info> list = cs.getCityInfo((page1 - 1) * rows1, rows1,
				cityname, cityzm);
	...
	public @ResponseBody
	List<City_info> citytype3(String id) {
	...
	@RequestMapping(params = "method=addcity")
	public @ResponseBody
	Json addcity(City_info city_info) {
		System.out.println(city_info.getCity_type() + ","
				+ city_info.getCitye_parent_id() + ","
	...
	@RequestMapping(params = "method=updatecity")
	public @ResponseBody
	Json updatecity(City_info city_info) {
		System.out.println(city_info.getCity_type() + ","
				+ city_info.getCitye_parent_id() + ","
				+ city_info.getCityname());
		Json json = new Json();
	...
	@RequestMapping(params = "method=deletecity")
	public @ResponseBody
	Json deletecity(City_info city_info) {
		System.out.println(city_info.getCity_type() + ","
				+ city_info.getCitye_parent_id() + ","
				+ city_info.getCityname());
		Json json = new Json();
