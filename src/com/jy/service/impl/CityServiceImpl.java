	...
	public String getcitytype1() {
		...
		if (city_infos.size() > 0) {
			for (City_info city_info : city_infos) {
				sb.append("{\"id\":\"" + city_info.getCitycode()
						+ "\",\"citytype\":\"" + city_info.getCity_type()
						+ "\",\"iconCls\":\"" + "icon-world" + "\",\"fid\":\""
						+ city_info.getCitye_parent_id() + "\",\"text\":\""
						+ city_info.getCityname() + "\",\"parent_id\":\""
