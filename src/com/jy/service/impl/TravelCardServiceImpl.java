...
public class TravelCardServiceImpl implements TravelCardService {
	...
	private String uuid;
	public List<TravelCard> getTravel(Integer page, Integer rows,String plateNumber,String did) {
		List<TravelCard> list = traveldao.getTravel(page, rows, plateNumber,did);
		return list;
	}

	public int getCount(String plateNumber,String did) {
		int i = traveldao.getCount(plateNumber,did);
		return i;
	}
	...
	public List<TravelCard> getAllCar(String[] putCarId) {
		// TODO Auto-generated method stub
		return traveldao.getAllCar(putCarId);
	}
	//当月年审到期
