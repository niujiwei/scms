...
public class Payable_feeServiceImpl implements Payable_feeService {
	...
	public int update1(String shiping_order_id, String write_off,
		...
		int  i = payable_feeDAO.update1(shiping_order_id, write_off, fee_date, people_zhong,Fee_remarks);
		return i;
	}
	...
	public List<ShippingOrder> getDelivery(int rows, int page,
			...
			String send_fee) {
		List<ShippingOrder> list = payable_feeDAO.getDelivery(rows, page, send_station, end_address, send_time, yy, car_name, send_date, dd, create_time, ss, write_off1, receipt, goods_name, goods_num, pay_type, send_fee);
		return list;
	}
	...
	public int getDeliveryInfo(String send_station, String end_address,
			...
			String pay_type, String send_fee) {
		int i = payable_feeDAO.getDeliveryInfo(send_station, end_address, send_time, yy, car_name, send_date, dd, create_time, ss, write_off1, receipt, goods_name, goods_num, pay_type, send_fee);
		return i;
	}
