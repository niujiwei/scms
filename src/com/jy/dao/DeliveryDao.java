...
public  interface DeliveryDao {
	...
	int getDelivery(String endaddress,String num,String carnum,String receipt,String pay_type,String send_type,String custom_name,String order_state);//查询总数
	List<Delivery> getDeliveryInfo(int rows,int page,String endaddress,String num,String carnum,String receipt,String pay_type,String send_type,String custom_name,String order_state);	//全部查询
	List<Delivery> outgetDeliveryInfo(String endaddress,String num,String carnum,String receipt,String pay_type,String send_type,String custom_name,String order_state);	//全部查询
	  ...
	  * 提货查询
	  */
	 int getSign(String num,String carnum,String receipt,String signperson,String goods_name,String goods_num,String pay_type,String send_time,String end_date);//查询总数
	 List<Delivery> getDeliverySign(int rows,int page,String num,String carnum,String receipt,String signperson,String goods_name,String goods_num,String pay_type,String send_time,String end_date);//查询全部
	 List<Delivery> outgetSign(String num,String carnum,String receipt,String signperson,String goods_name,String goods_num,String pay_type,String send_time,String end_date);
	 /**
	  * 转运查询
	  */
	 int gettransferGoods(String  endaddress,String num,String carnum,String receipt,String changecompany,String pay_type,String goods_name,String goods_num,String order_state,String send_time,String end_date);//查询总数
	 List<Delivery> gettransferGoodsInfo(int rows,int page,String  endaddress,String num,String carnum,String receipt,String changecompany,String pay_type,String goods_name,String goods_num,String order_state,String send_time,String end_date);//查询全部
	 List<Delivery> outgettransferGoods(String  endaddress,String num,String carnum,String receipt,String changecompany,String pay_type,String goods_name,String goods_num,String order_state,String send_time,String end_date);
	 /**
	  * 送货查询
	  */
	 int deliverGoods(String send_time,String send_timet,String num ,String carnum ,String signperson ,String goods_name,String goods_num ,String car_name,String receipt_address,String order_state);//查询总数
	 List<Delivery> deliverGoodsInfo(int rows,int page,String send_time,String send_timet,String num ,String carnum ,String signperson ,String goods_name,String goods_num ,String car_name,String receipt_address,String order_state);//查询全部
	  ...
	  */
	 	 List<Delivery>selectCompany(String  company);
	 		 ...
	 		 */
	 			  ...
	 			  * @return
	 			  */
	 			 List<Delivery>selectCustom(String  custom_name);
