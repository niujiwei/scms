...
int editOther1(String shiping_order_id,String write_off2,String other_date,String people_other );
	...
	public int getPayable_feeInfo( String shiping_order_num,String receipt ,String fee_date,String dd,String create_time,String yy,String write_off,String send_station,String goods_name,String goods_num,String pay_type,String paid,String company_name);//查询总数
	 ...
	 //
	 int update1(String shiping_order_id,String write_off ,String fee_date,String people_zhong,String Fee_remarks);//用户修改
	 ShippingOrder getupdate1(String id);//修改查询
	 //应付送货费
		List<ShippingOrder> getDelivery(int rows,int page,String send_station,String end_address,String send_time,String yy,String car_name, String send_date,String dd,String create_time,String ss,String write_off1,String receipt,String goods_name,String goods_num,String pay_type,String send_fee);
		public int getDeliveryInfo( String send_station,String end_address,String send_time,String yy,String car_name, String send_date,String dd,String create_time,String ss,String write_off1,String receipt,String goods_name,String goods_num,String pay_type,String send_fee);//查询总数
