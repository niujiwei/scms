...
public interface BaiDuMapDao {
	 ...
	 * @return
	 */
	public List<OrderHistory> getShippingOrderHistoyInfo(
	 ...
	 * @return
	 */
	public User getUserInfo(@Param("driverId") String driverId);
	 ...
	 * @return
	 */
	public Driver getDriverInfo(@Param("orderId") String orderId);
	 ...
	 * @return
	 */
	public Map<String, String> getRecSinTime(@Param("orderId") String orderId);
	 ...
	 * @return
	 */
	public ShippingOrder getShippingOrderInfo(@Param("orderId") String orderId);
	 ...
	 * @return
	 */
	public DeliveryCustomer getDeliveryCustomerInfo(
	 ...
	 * @return
	 */
	public int loadMapPointCount(String tablename, String carno, String starttime,
